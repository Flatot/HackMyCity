<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#">E-Admin</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#demarche">Démarches</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#param">Paramètres</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="container-fluid">
	  ...
	  <header class="jumbotron my-4 flag">
			<h1 class="">Bienvenue</h1>
			<p>Monsieur XXXXX YYYYYY</p>
		  </header>
